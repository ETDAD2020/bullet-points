...
include('http://ajax.googleapis.com/ajax/libs/jquery/1.7.0/jquery.min.js', function() {
    ...
    $(document).ready(function() {
        $('head').append('<link rel="stylesheet" href="https://app.storeks.com/css/storefront.css" type="text/css" />');
        $.getJSON("https://app.storeks.com/get-app-settings?shop_name=" + shop_domain, function (data) {
