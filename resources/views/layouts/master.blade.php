...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand p-0">
        <a class="navbar-brand text-left col-xs-12 col-md-3 col-lg-2 mr-2 text-white" ><img src="{{ asset('IconTransp.png') }}" alt="" style="width: 75px; height: auto;">Ultimate Bullet Points</a>
                ...
                <ul class="polished-sidebar-menu ml-0 pt-4 p-0 d-md-block">
                    ...
                    @auth
                        @if(auth()->user()->role != 'admin')
                            <li class="{{ request()->is('dashboard') ? 'active' : ''}}"><a href="{{ route('dashboards') }}?id={{ auth()->user()->id }}"><span class="oi oi-dashboard"></span> Dashboard</a></li>
