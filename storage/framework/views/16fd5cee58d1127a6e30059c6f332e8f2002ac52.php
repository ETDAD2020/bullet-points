                    ...
                    <div class="media shadow-sm p-0 bg-white rounded text-primary ">
                        ...
                        <div class="media-body p-2">
                            ...
                            <div class="media-text">
                                <h3><?php echo e(auth()->user()->products->count()); ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/516655.cloudwaysapps.com/fwkpfhbxsv/public_html/resources/views/welcome.blade.php ENDPATH**/ ?>