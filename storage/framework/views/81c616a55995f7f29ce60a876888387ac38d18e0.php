...
<nav class="navbar navbar-expand p-0">
    <a class="navbar-brand text-left col-xs-12 col-md-3 col-lg-2 mr-2 text-white" ><img src="<?php echo e(asset('logo.jpeg')); ?>" alt="" style="width: 25px; height: auto; margin-right: 5px; margin-bottom: 5px;">Triggersy</a>
