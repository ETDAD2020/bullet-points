        ...
        <div class="col-md-12 pl-3 pt-2">
            <div class="row pl-3">
                ...
                <form action="<?php echo e(route('settings.store')); ?>" method="POST">
                    ...
                    <?php echo csrf_field(); ?>
                    <input type="text"  name="icon" class="d-none selected-icon" <?php if($settings != null): ?> value="<?php echo e($settings->icon); ?>" <?php else: ?> value="" <?php endif; ?>>
                    <input type="text"  name="emoji" class="d-none selected-emoji" <?php if($settings != null): ?> value="<?php echo e($settings->emoji); ?>" <?php else: ?> value="" <?php endif; ?>>

                    <div class="col-md-12 col-lg-12 col-12 mb-2 col-sm-12">
                        <?php if($settings != null): ?>
                            <?php if($settings->icon !== null): ?>
                                <div class="p-3 bg-white-darker my-3" style="width: 95% !important;">
                                    <label class="fs-3">Selected Settings</label><br>
                                    <i class="fa <?php echo e($settings->icon); ?> fa-4x ml-3" style="color: <?php echo e($settings->color); ?>"></i>
                                </div>
                            <?php else: ?>
                                <div class="p-3 bg-white-darker my-3" style="width: 95% !important;">
                                    <label class="fs-3">Selected Settings</label><br>
                                    <p style="font-size:50px"><?php echo e($settings->emoji); ?></p>
                                </div>
                            <?php endif; ?>
                        <?php endif; ?>
...
<?php $__env->startSection('js'); ?>
    ...
    <script src="<?php echo e(asset('js/aliases.js')); ?>"></script>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/516655.cloudwaysapps.com/fwkpfhbxsv/public_html/resources/views/customizer/index.blade.php ENDPATH**/ ?>